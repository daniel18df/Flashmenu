                              ...
                              <div class="wrapper">
                                ...
                                <div class="extra-wrap">
                                    ...
                                    <div class="buttons">
                                        ...
                                        <a class="button-2" href="ingresarAdm.php" onClick="document.getElementById('contact-form').submit()" type ="submit" >Registrar</a>
...
<!-- -->
    ...
    <meta http-equiv="REFRESH" content="0;url=http://www.flashmenu.cl/web/perfilAdm.php?var1=<?php echo "$idAdministrador_restaurant"?><?php echo "&admnombre=$Adm_nombre"?>">
