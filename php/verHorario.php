...
$result = mysql_query("SELECT *FROM Horarios_mesa, Mesa WHERE Restaurant_idRestaurant = '$buscar' AND Mesa_Nro_mesa = Nro_mesa AND Horarios_mesa_fecha = '$buscar2'") or die(mysql_error());
...
if (mysql_num_rows($result) > 0) {
    ...
    // success
    $response["success"] = 1;
    $response["query"] = "SELECT *FROM Horarios_mesa, Mesa WHERE Restaurant_idRestaurant = $buscar AND Mesa_Nro_mesa = Nro_mesa AND Horarios_mesa_hora = $buscar2";
