    ...
    <header>
        ...
        <div class="row-bot">
        	<div class="row-bot-bg">
            	<div class="main">
                	<h2>Inicio sesion <span>Administrador del Sistema</span></h2>
                </div>
            </div>
        </div>
    </header>
    ...
    <section id="content"><div class="ic"></div>
       <div class="main">
            <div class="wrapper">
                    ...
                    <form class="basic-grey" id="contact-form" method="post" enctype="multipart/form-data" action="loginAdmSist.php">                    
                              ...
                              <div class="wrapper">
                                ...
                                <div class="extra-wrap">
                                    ...
                                    <div class="buttons">
                                        ...
                                        <a class="button-2" href="ingresarAdmSist.php" onClick="document.getElementById('contact-form').submit()" type ="submit" >Registrar</a>
