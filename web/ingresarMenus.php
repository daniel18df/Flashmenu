...
if(isset($_POST['submit'])){
  // include db connect class
    ...
    $precio = $_POST['precio'];
  $query = "INSERT INTO Menu (Menu_nombre, Menu_descripcion, Menu_precio, Restaurant_idRestaurant) VALUES ('$nombre', '$descripcion', '$precio', '$var1')";
    ...
    <header>
        ...
        <div class="row-bot">
        	<div class="row-bot-bg">
            	<div class="main">
                	<h2>Ingresar <span>menús</span></h2>
                </div>
            </div>
        </div>
    </header>
