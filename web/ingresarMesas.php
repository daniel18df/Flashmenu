...
if(isset($_POST['submit'])){
  ...
  $query = "INSERT INTO Mesa (Mesa_nro, Mesa_descripcion, Mesa_cantPersonas, Restaurant_idRestaurant) VALUES ('$nro', '$descripcion', '$cantPersonas', '$var1')";
     if (!mysql_query($query))
         {
         die('Error: ' . mysql_error());
       //  echo "Error al crear la mesa." . "<br />";
         }
         else{
       //  echo "<br />" . "<h2>" . "Mesa Creada Exitosamente!" . "</h2>";
       //  echo "<h4>" . "Nro mesa: " . $_POST['nro'] . "</h4>";
         }
         //}
    ...
    <section id="content"><div class="ic"></div>
        <div class="main">
            <div class="wrapper">
                   ...
                   <form  class="basic-grey" action="ingresarMesas.php?var1=<?php echo $var1?><?php echo "&perfilAdm=$perfilAdm"?>">
